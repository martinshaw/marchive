...
import { CaptureEntityType, CapturePartEntityType, DataProviderSerializedType, ScheduleEntityType, SourceEntityType } from "common-types";
...
export type DataProvidersRendererComponentCapturePartPreviewThumbnailPropsType = {
  ...
  capturePart: CapturePartEntityType;
