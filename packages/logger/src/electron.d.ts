 ...
 * File Name: electron.d.ts
 * Created:  2023-10-10T04:44:48.971Z
 * Modified: 2023-10-10T04:44:48.971Z
 *
 * These optional extensions of the NodeJS 'process' module allow us to access information about the Electron process, 
 * assuming that the process is or is not running in an Electron environment.
 *
 * It is copied from the `electron.d.ts` file in the `electron` package, which is a dependency of the 'electron-app' 
 * monorepo sub-package so that I do not have to install it as a dependency of this much smaller package.
*/

// Type definitions for Electron 25.9.0
